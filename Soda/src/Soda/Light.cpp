...
namespace Soda
{
	Light* Light::SetLightType(LightType type, const std::shared_ptr<Shader>& shader)
	{
		switch (type)
		{
	...
	//*** Directional Light ***//
	void DirectionalLight::UpdateInformation(const std::shared_ptr<Shader>& shader)
	{
	...
	void DirectionalLight::UpdateSettings(const std::shared_ptr<Shader>& shader)
	{
	...
	//*** Point Light ***//
	void PointLight::UpdateInformation(const std::shared_ptr<Shader>& shader)
	{
	...
	void PointLight::UpdateSettings(const std::shared_ptr<Shader>& shader)
	{
	...
	void PointLight::UpdateCutOffAndAttenuation(const std::shared_ptr<Shader>& shader)
	{
	...
	//*** Spot Light ***//
	void SpotLight::UpdateInformation(const std::shared_ptr<Shader>& shader)
	{
	...
	void SpotLight::UpdateSettings(const std::shared_ptr<Shader>& shader)
	{
	...
	void SpotLight::UpdateCutOffAndAttenuation(const std::shared_ptr<Shader>& shader)
	{
